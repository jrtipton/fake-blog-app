...
#
docker_build('jrtipton/fake-blog-app:2',
             context='.',
...
k8s_yaml(namespace_yaml('fake-blog-app'), allow_duplicates=False)
...
#
k8s_yaml(['charts/deployment.yaml', 'charts/service.yaml'])
...
#
k8s_resource('fake-blog-app',
             #              # map one or more local ports to ports on your Pod
             port_forwards=['8008:3000'],
